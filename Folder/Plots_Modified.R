...
#
#
nodes = read_csv(choose.files(default = "", caption = "Select nodes file",multi = TRUE, filters = Filters,index = nrow(Filters)),
col_names = T, col_types = NULL)

links = read_csv(choose.files(default = "", caption = "Select edges file",multi = TRUE, filters = Filters,index = nrow(Filters)),
col_names = T, col_types = NULL)
...
#
{
  ...
  #>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
  # New label
  terms01 = nodes$Term[1:total.terms]
  w = c()
  for (i in terms01) {
    numero.palabras = sapply(strsplit(i," "), length)
    if (numero.palabras <= 3) {
      ee = str_sort(i, numeric = TRUE)
      pp = gsub("[[:space:]]", "\n", ee)
      w[pp] = pp
    } else if (numero.palabras >= 4) {
      ee = word(i, 1,3)
      ee = str_sort(ee, numeric = TRUE)
      pp = gsub("[[:space:]]", "\n", ee)
      pp = gsub('$', '...', pp)
      w[pp] = pp
    }
  ...
  letra = c(rep("bold", total.terms), rep("plain", length(only.entrys)))
  letra2 = c(rep(NA, total.terms), rep("plain", length(only.entrys)))
  #>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
  
  V(link_tbl)$Label = c(w,
                        as.character(nodes$Entry[start.entry:total.nodes]))
  
  V(link_tbl)$Etiqueta = c(w, as.character(rep(NA,total.nodes - total.terms)))
...
if (ncol(nodes) == 7) {
  ...
  for (i in layouts){
    ...
    {
      png(file=paste0("NeVOmics_Plot_Network_Des_Layout_",i,".png"),
          width = width.png,  #<---------------------
          height = 15, 
          units = "cm",
          res=900,bg="white")
  ...
  for (i in layouts){
    ...
    graf1 = graf1 + scale_color_gradient(low = c("green","black"), high = "red") +
      labs(caption = paste("NeVOmics:",sep=" ",format(Sys.time(),"%a(%d)/%b/%Y   %X")))
    {
      png(file=paste0("NeVOmics_Plot_Network_Des_Layout_Ter_",i,".png"),
          width = width.png,  #<---------------------
          height = 15, 
          units = "cm",
          res=900,bg="white")
  ...
  for (i in layouts){
    ...
    graf1 = graf1 + scale_color_gradient(low = c("green","black"), high = "red") +
      labs(caption = paste("NeVOmics:",sep=" ",format(Sys.time(),"%a(%d)/%b/%Y   %X")))
    {
      png(file=paste0("NeVOmics_Plot_Network_Id_Layout_",i,".png"),
          width = width.png,  #<---------------------
          height = 15, 
          units = "cm",
          res=900,bg="white")
  ...
  for (i in layouts){
    ...
    graf1 = graf1 + scale_color_gradient(low = c("green","black"), high = "red") +
      labs(caption = paste("NeVOmics:",sep=" ",format(Sys.time(),"%a(%d)/%b/%Y   %X")))
    {
      png(file=paste0("NeVOmics_Plot_Network_Layout_",i,".png"),
          width = width.png,  #<---------------------
          height = 15, 
          units = "cm",
          res=900,bg="white")
  ...
  if (length(only.entrys) > 80) {
    ...
    for (i in modelos){
      ...
      graf1 = graf1 + scale_color_gradient(low = c("green","black"), high = "red") +
        labs(caption = paste("NeVOmics:",sep=" ",format(Sys.time(),"%a(%d)/%b/%Y   %X")))
      {
        png(file=paste0("NeVOmics_Plot_Network_Des_Layout_XL_",i,".png"),
            width = width.png,  #<---------------------
            height = 15, 
            units = "cm",
            res=900,bg="white")
  ...
  if (total.terms <= 30) {
    ...
    for (i in layouts){
        ...
        labs(caption = paste("NeVOmics:",sep=" ",format(Sys.time(),"%a(%d)/%b/%Y   %X")))
      {
        ...
        ## Save plot
        png(file=paste("NeVOmics_Plot_Network_Bar_Des_Layout_",i,".png"),
            width = 25,
            height = 15,
            units = "cm",
            res=900,bg="white")
    ...
    for (i in layouts){
        ...
        labs(caption = paste("NeVOmics:",sep=" ",format(Sys.time(),"%a(%d)/%b/%Y   %X")))
      {
        ...
        plot.with.inset = ggdraw() +
          ...
          draw_plot(barplot.enrichment, .71,.01, .25, .87)
        ## Save plot
        png(file=paste("NeVOmics_Plot_Network_Bar_Des_Layout_Ter_",i,".png"),
            width = 25,
            height = 15,
            units = "cm",
            res=900,bg="white")
    ...
    for (i in layouts){
        ...
        labs(caption = paste("NeVOmics:",sep=" ",format(Sys.time(),"%a(%d)/%b/%Y   %X")))
      {
        ...
        plot.with.inset = ggdraw() +
          ...
          draw_plot(barplot.enrichment, .71,.01, .25, .87)
        ## Save plot
        png(file=paste("NeVOmics_Plot_Network_Bar_Id_Layout_",i,".png"),
            width = 25,
            height = 15,
            units = "cm",
            res=900,bg="white")
    ...
    for (i in layouts){
        ...
        labs(caption = paste("NeVOmics:",sep=" ",format(Sys.time(),"%a(%d)/%b/%Y   %X")))
      {
        ...
        plot.with.inset = ggdraw() +
          ...
          draw_plot(barplot.enrichment, .71,.01, .25, .87)
        ## Save plot
        png(file=paste("NeVOmics_Plot_Network_Bar_Layout_",i,".png"),
            width = 25,
            height = 15,
            units = "cm",
            res=900,bg="white")
      ...
      for (i in modelos){
          ...
          labs(caption = paste("NeVOmics:",sep=" ",format(Sys.time(),"%a(%d)/%b/%Y   %X")))
        {
          ...
          plot.with.inset = ggdraw() +
            ...
            draw_plot(barplot.enrichment, .71,.01, .25, .87)
          ## Save plot
          png(file=paste("NeVOmics_Plot_Network_Bar_Id_Layout_XL_",i,".png"),
              width = 25,
              height = 15,
              units = "cm",
              res=900,bg="white")
    ...
    if (length(only.entrys) > 80) {
      ...
      for (i in modelos){
          ...
          labs(caption = paste("NeVOmics:",sep=" ",format(Sys.time(),"%a(%d)/%b/%Y   %X")))
        {
          ...
          ## Save plot
          png(file=paste("NeVOmics_Plot_Network_Bar_Des_Layout_XL_",i,".png"),
              width = 35,
              height = 15,
              units = "cm",
              res=900,bg="white")
  ...
  if (length(only.entrys) > 1) {
    if ((total.terms > 1) && (total.terms <= 15)) {
      ...
      for (i in -1:0) {
        ...
        #
        {
          png(file=paste0("NeVOmics_Plot_Chord_1_",i,".png"),
              width = 30,
              height = 10,
              units = "cm",
              res=1024,bg="white")
        ...
        #
        {
          png(file=paste0("NeVOmics_Plot_Chord_2_",i,".png"),
              width = 30,
              height = 10,
              units = "cm",
              res=900,bg="white")
  ...
  #
  #
  {png(file="NeVOmics_Plot_UpSetR.png",width = 10,height = 7,units = "in",res=900,bg="white")
  ...
  if (length(only.entrys) > 80) {
    ...
    for (i in modelos){
      ...
      graf1 = graf1 + scale_color_gradient(low = c("green","black"), high = "red") +
        labs(caption = paste("NeVOmics:",sep=" ",format(Sys.time(),"%a(%d)/%b/%Y   %X")))
      {
        png(file=paste0("NeVOmics_Plot_Network_Layout_XL_",i,".png"),
            width = width.png,  #<---------------------
            height = 15, 
            units = "cm",
            res=900,bg="white")
