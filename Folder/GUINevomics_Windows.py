...
bpgr = IntVar()#--------------------------------------------------------------
siete = Checkbutton(group_plots, text='', font=("Arial", 10),activebackground= 'yellow',
...
mfgr = IntVar()#--------------------------------------------------------------
siete1 = Checkbutton(group_plots, text='', font=("Arial", 10),activebackground= 'yellow',
...
ccgr = IntVar()#--------------------------------------------------------------
siete2 = Checkbutton(group_plots, text='', font=("Arial", 10),activebackground= 'yellow',
...
kegggr = IntVar()#--------------------------------------------------------------
siete3 = Checkbutton(group_plots1, text='', font=("Arial", 10),activebackground= 'yellow',
...
keggblgr = IntVar()#--------------------------------------------------------------
siete4 = Checkbutton(group_plots2, text='', font=("Arial", 10),activebackground= 'yellow',
...
subir_archivo = Label(root, text="3. Visualizations", font=("Arial", 15, "bold"))
...
textonet1 = Label(plot_space, text="Networks :", font=("Arial", 12, "bold"))
textonet1.grid(column=5, row=3, sticky= W)

textonet2 = Label(plot_space, text="Node colors if there are values:", font=("Arial", 10))
textonet2.grid(column=5,columnspan=2, row=4, sticky= W)

textonet3 = Label(plot_space, text="Terms and Edges color:", font=("Arial", 10))
textonet3.grid(column=5, columnspan=2, row=7, sticky= W)

textonet4 = Label(plot_space, text="Node colors if there are no values:", font=("Arial", 10))
textonet4.grid(column=5,  columnspan=2, row=10, sticky= W)

textonet5 = Label(plot_space, text="Colormap title (default: LogFC):  ", font=("Arial", 10))
textonet5.grid(column=5, columnspan=2,  row=11, sticky= W)
...
def color_palettes():
    ...
    for i, j in enumerate(clases.keys()):
        ...
        seis = Label(clases[j], text=j.split('/')[1].split('.')[0], font=("Arial", 10, "bold"))
...
b1 = Button(plot_space, text='GreBlaRed', bg="#000000", fg="white", font=("Arial", 8),
            command=color_palettes,
           activebackground = 'yellow', activeforeground = 'black')
b1.grid(column = 7, row = 4)
...
lbl2.grid(column=5, columnspan=5, row=8, rowspan=2, sticky= W)
...
colmap = Button(plot_space, text='Colormap8', bg="#000000", fg="white", font=("Arial", 8),
                command= edgeCOLORMAP, activebackground = 'yellow', activeforeground = 'black')
colmap.grid(column = 7, row = 7, sticky= W)
...
sinback = tkinter.Button(plot_space, text='#0000ff', font=("Arial", 8), bg= '#0000ff', command=color_button)
sinback.grid(column=7, row=10, sticky= W)
...
changetitle = Button(plot_space, text="     Title     ", bg="#000000", fg="white", font=("Arial", 8),
                     activebackground = 'yellow', activeforeground = 'black', command=USERTEXT)
changetitle.grid(column = 7, row = 11, sticky= W)


#######   CIRCOS

plot_space2 = LabelFrame(root) # 
plot_space2.grid(column=5, columnspan = 4, row=11, rowspan=5, sticky= W)
 
nota = Label(plot_space2, text="[To use this application you need to install R]",
             font=("Arial", 10), fg="red")
nota.grid(column=5, columnspan = 4, row=10, sticky= W)
...
link.grid(column=5, columnspan = 4, row=11, sticky= W)
link.bind("<Button-1>", callback)


nota2 = Label(plot_space2, text="[The same colors of the networks will be used,\nyou can modify the parameters above]", font=("Arial", 9))
nota2.grid(column=5, columnspan = 4, row=12, sticky= W)



textonet11 = Label(plot_space2, text="Chords : ", font=("Arial", 12, "bold"))
textonet11.grid(column=5, row=13, sticky= W)

textonet22 = Label(plot_space2, text="Locate the R.exe program:", font=("Arial", 8))
...
siete5.grid(column = 6, row = 13, sticky= W)
...
boton22 = Button(plot_space2, text=" R.exe      ", bg="#000000", fg="white",
                font=("Arial", 8),
                activebackground= 'yellow',activeforeground= 'black',
                cursor="hand2", command = r_exe_loc)
boton22.grid(column=7, row=14, sticky= W)
...
boton33 = Button(plot_space2, text=" R Library ", bg="#000000", fg="white",
                font=("Arial", 8),
                activebackground= 'yellow',activeforeground= 'black',
                cursor="hand2", command = r_lib_loc)
boton33.grid(column=7, row=15, sticky= W)
...
label = Label(root,
             text="4. Node label", font=("Arial", 15, "bold"))
...
for i, tips in enumerate(etiquetas):
    radio7 = Radiobutton(group_label5, text = tips, font=("Arial", 10), cursor="hand2",
                         activebackground = 'black', activeforeground = 'lightgray',
...
ejemplo.grid(column=10, columnspan = 1, row=7, rowspan=8, sticky= W+E)
...
labnet.grid(column = 10, row = 7, rowspan=8, sticky= W+E)
