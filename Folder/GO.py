...
if len(inp_file.columns) == 3:
    ...
    file='GO_BP.txt'
    fdr_min=0.05
    subprocess.call(["python","Hypergeometric_distribution.py",file,str(fdr_min),'data/Enrichment_analysis_GO_BP.tsv'])
    ...
    file='GO_MF.txt'
    fdr_min=0.05
    subprocess.call(["python","Hypergeometric_distribution.py",file,str(fdr_min),'data/Enrichment_analysis_GO_MF.tsv'])
    ...
    file='GO_CC.txt'
    fdr_min=0.05
    subprocess.call(["python","Hypergeometric_distribution.py",file,str(fdr_min),'data/Enrichment_analysis_GO_CC.tsv'])
