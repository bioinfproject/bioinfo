...
# <img src="https://raw.githubusercontent.com/bioinfproject/bioinfo/master/Folder/Figure_1.png" width = 70%>
...
### `Warning`
#### `Before running NeVOmics you need to install Python.`<br>`If you input file is .fasta, you need to install BLAST.`<br>`If your want to get Circos Plot you need to install R.`<br>
