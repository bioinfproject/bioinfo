...
## <span style="color:red"><b>!!! Before running NeVOmics you nedd to install Python ().<br>!!! If you input file is .fasta, you need to install BLAST ().<br>!!! If your want to get Circos Plot you need to install R ().</span>
