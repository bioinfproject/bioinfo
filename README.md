<img src="https://raw.githubusercontent.com/bioinfproject/bioinfo/master/Folder/NeVOmics_Update.jpg" width = 100%><br>
...
# <img src="https://raw.githubusercontent.com/bioinfproject/bioinfo/master/Folder/Figure_1.png" width = 100%>
...
## Download [**NeVOmics**](https://drive.google.com/uc?export=download&confirm=1o_3&id=1tfCEVCMCIh5kxWpecv9sEOmu8O_lDeys) for <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/NewTux.svg/300px-NewTux.svg.png" width = 5%><br><br>
...
```bash
Double-click on NeVOmics.exe
```
```bash
python3 NeVOmics.py
```
### **3**. Select one of the three available analyzes and configure the visualization parameters.
<hr />
<hr />
